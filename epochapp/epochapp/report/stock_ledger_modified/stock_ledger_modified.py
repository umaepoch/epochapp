...
def execute(filters=None):
        ...
        for sle in sl_entries:
                ...
                data.append([sle.date, item_detail.item_name, sle.warehouse, item_detail.stock_uom,
                        sle.actual_qty, sle.qty_after_transaction,
                        (sle.incoming_rate if sle.actual_qty > 0 else 0.0),
                        sle.valuation_rate, sle.stock_value, sle.voucher_type, sle.voucher_no, sle.item_code,
...
def get_columns():
        return [_("Date") + ":Datetime:95", _("Item Name") + "::100", _("Warehouse") + ":Link/Warehouse:100",
                ...
                _("Voucher Type") + "::110", _("Voucher #") + ":Dynamic Link/" + _("Voucher Type")+":100", _("Item") + ":Link/Item:130",
